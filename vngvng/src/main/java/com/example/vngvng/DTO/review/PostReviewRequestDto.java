...
public class PostReviewRequestDto {
    ...
    @Builder
    public PostReviewRequestDto(Member member, Long reviewId, LocalDateTime writeTime, Seat seat, Artist artist, Show show, Venue venue, Evaluation evaluation, String textReview, List<PhotoReview> photoReviews){
        this.member = member;
